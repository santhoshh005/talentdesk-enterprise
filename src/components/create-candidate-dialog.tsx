    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[500px] max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            Manually add a new candidate to your database. All fields marked with * are required.
          </DialogDescription>
        </DialogHeader>
        <form onSubmit={handleSubmit} className="space-y-4 pt-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="space-y-1.5">
              <Label htmlFor="currentRole">
                Target / Current Role <span className="text-destructive">*</span>
              </Label>
              <Input
                id="currentRole"
                value={currentRole}
          ...
          <div className="space-y-1.5">
            ...
            <Textarea
              ...
              rows={3}
              placeholder="Brief summary of candidate experience and background..."
            />
          </div>
