    ...
    <div className="min-h-dvh grid grid-cols-1 lg:grid-cols-12 bg-background">
      ...
      <div className="lg:col-span-5 flex flex-col justify-between px-6 py-10 sm:px-12 xl:px-16 z-10 border-r border-border/50">
        ...
        <div className="flex items-center justify-between text-xs text-muted-foreground pt-4">
          ...
          <span className="flex items-center gap-1.5 text-success font-medium">
            <span className="size-2 rounded-full bg-success animate-pulse" /> All Systems Operational
          </span>
        </div>
      </div>
      ...
      <div className="hidden lg:col-span-7 lg:flex relative overflow-hidden bg-slate-950 text-white flex-col justify-between p-12">
        ...
        <div className="relative z-10 my-auto max-w-lg space-y-8">
          <div className="space-y-3">
            ...
            <p className="text-sm text-slate-400 leading-relaxed">
              Automate resume evaluations, job description generation, and candidate scoring in a single unified workspace.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 gap-3">
            {[
              { icon: Zap, title: "Instant Resume Parser", desc: "0ms extraction of skills, experience, and executive AI summaries", badge: "0ms Speed" },
              { icon: Target, title: "AI Candidate Matching", desc: "Rank candidates accurately against your open positions", badge: "98% Accuracy" },
              { icon: Bot, title: "Automated Interview Kits", desc: "Generate tailored interview questions & evaluation rubrics in seconds", badge: "Automated" },
            ].map((f) => (
              <div 
                key={f.title} 
              ...
              >
                ...
                <div className="min-w-0 flex-1">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="rounded-full bg-primary/20 px-2 py-0.5 text-[10px] font-medium text-primary-foreground border border-primary/30">{f.badge}</span>
                  </div>
        ...
        <div className="relative z-10 flex items-center justify-between text-xs text-slate-400">
          ...
          <span className="flex items-center gap-1"><CheckCircle2 className="size-3 text-success" /> Secure & Encryption Protected</span>
        </div>
      </div>
    </div>
  );
