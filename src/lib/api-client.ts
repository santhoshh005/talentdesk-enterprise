...
export const api = {
  ...
  updateCandidate: (id: string, data: any) =>
    apiFetch(`/candidates/${id}`, { method: "PATCH", body: JSON.stringify(data) }),
  ...
  batchMatchCandidates: (data: { candidates: any[]; jobTitle: string }) =>
    apiFetch("/ai/batch-match-candidates", { method: "POST", body: JSON.stringify(data) }),
